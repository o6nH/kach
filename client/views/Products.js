      ...
      <div className="contiainer p-2">
        <div className="row">
          ...
          <div className="col-md">
            <div className="row-sm d-flex flex-row justify-content-around flex-wrap">
              {
                categories.length 
                ? filteredProducts.map(product => <ProductCard key={product.id} product={product} className="col-xs"/>) 
                : ''
              }
            </div>
          </div>
